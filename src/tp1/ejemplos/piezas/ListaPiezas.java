...
/**
 * 
 * Implementa una lista de objetos de tipo Pieza con array estático y contador
 * (Ejemplo para TP1 - UCM)
 * 
...
public class ListaPiezas {
	...
	// Contador de piezas en array (coincidirá con la primera posición libre del
	// array)
	...
	/**
	 * Comprueba si una lista está llena y, en caso contrario, inserta una nueva
	 * pieza
	 * 
	 * @param p Nueva pieza
